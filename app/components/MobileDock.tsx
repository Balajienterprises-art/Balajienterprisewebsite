...
export function MobileDock() {
  return (
    <div className="md:hidden fixed bottom-6 left-1/2 -translate-x-1/2 bg-[#0F3D81]/90 backdrop-blur-xl text-white border border-white/10 z-50 flex items-center justify-around gap-8 px-8 py-4 rounded-full shadow-[0_8px_32px_rgba(0,0,0,0.4)]">
