        ...
        <div className="relative z-10 max-w-5xl mx-auto space-y-4 md:space-y-6">
          ...
          <div className="flex justify-center mb-2">
            ...
            >
              ...
              <span className="font-mono text-[8px] md:text-[9px] text-accent-brass font-black uppercase tracking-widest">Top Electrical Supplier in Surat</span>
            </motion.div>
          </div>
          ...
          >
            A leading wholesale distributor for HT/LT electrical products. We supply bulk PVC Insulation Tapes, Bare Copper Wire, and Industrial Brass Hardware across Gujarat.
          </motion.p>
      ...
      <section id="services" className="py-16 md:py-32 px-6 lg:px-20 bg-white">
        <div className="max-w-7xl mx-auto">
          <motion.div {...fadeUp} className="mb-12 md:mb-20 max-w-2xl text-center md:text-left">
            ...
            <h2 className="text-3xl md:text-6xl font-heading font-bold text-brand-primary mt-4 tracking-tighter uppercase italic">Wholesale Electrical Materials</h2>
          ...
          >
            <div className="space-y-4">
               ...
               <h2 className="text-3xl sm:text-4xl md:text-7xl font-heading font-bold uppercase italic leading-[1.1] md:leading-[0.9] tracking-tighter">
                 Surat&apos;s Trusted <br/> Electrical Supplier.
               </h2>
            </div>
